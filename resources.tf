...
resource "aws_ecs_cluster" "mycluster" {
    name= "app-cluster" #nombramos al cluster
}

# DEBEMOS DEFINIR LAS TAREAS QUE VAN A EJECUTARSE
...
#CREAR UNA VPC y SUBNET para nuestra zona de aws
# main.tf
...
# Esto va a ejecutar el cluster, tareas y Fargate
resource "aws_ecs_service" "app_service" {
  name            = "app-first-service"     # Name the service
  cluster         = "${aws_ecs_cluster.mycluster.id}"   # Reference the created Cluster
